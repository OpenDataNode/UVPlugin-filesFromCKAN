...
public class OrganizationItem implements CkanTreeItem {
    
    public String id;
    public String name;
    public String title;
    public String description;
    public List<DatasetItem> datasets;
    
    public OrganizationItem(String id, String name) {
        this.id = id;
        this.name = name;
    }

    public OrganizationItem(JsonObject org) {
        ...
        this.datasets = new ArrayList<DatasetItem>();
    ...
    public void loadDatasets(JsonArray datasets) {
        ...
        if (datasets != null) {
            for (JsonObject dataset : datasets.getValuesAs(JsonObject.class)) {
                this.datasets.add(new DatasetItem(dataset));
            }
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        OrganizationItem other = (OrganizationItem) obj;
        if (id == null) {
            if (other.id != null)
                return false;
